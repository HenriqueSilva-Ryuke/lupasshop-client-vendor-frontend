...
const ORDER_STATUS_LABELS: Record<string, { label: string; color: string }> = {
  ...
  PROCESSING: { label: 'Em Processamento', color: 'bg-indigo-100 text-indigo-700' },
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap gap-6 text-sm">
        ...
        <div>
          <p className="text-gray-500 text-xs mb-1">Código de Rastreio</p>
        ...
        <div>
          <p className="text-gray-500 text-xs mb-1">Previsão de Entrega</p>
        ...
        <div>
          <p className="text-gray-500 text-xs mb-1">Status do Envio</p>
            ...
            <div className="divide-y">
              {(order.orderItems ?? []).map((item: any) => (
                <div key={item.id} className="flex gap-4 items-center px-6 py-4">
                  <div className="w-16 h-16 rounded-lg overflow-hidden shrink-0 bg-gray-100 border">
          ...
          <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
            ...
            <div className="px-6 py-5">
              {returnsLoading ? (
                ...
                <div className="space-y-3">
                  {returns.map((ret: any) => {
                    const rs = RETURN_STATUS_LABELS[ret.status] ?? { label: ret.status, color: 'bg-gray-100 text-gray-700', icon: null };
                    return (
