    ...
    },
    {
      ...
      links: [
        { 
          name: t('facebook'), 
          href: "#",
          icon: <FaFacebook className="text-white/40 group-hover:text-white text-lg" />
        },
        { 
          name: t('instagram'), 
          href: "#",
          icon: <FaInstagram className="text-white/40 group-hover:text-white text-lg" />
        },
        { 
          name: t('linkedin'), 
          href: "#",
          icon: <FaLinkedin className="text-white/40 group-hover:text-white text-lg" />
        }
      ]
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-white/10 py-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-white/60 text-xs">{t('copyright')}</div>
