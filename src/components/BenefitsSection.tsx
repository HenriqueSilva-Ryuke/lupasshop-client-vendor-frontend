...
export default function BenefitsSection() {
 ...
 >
 <motion.h2  className="text-4xl md:text-6xl font-bold mb-6 bg-linear-to-r from-primary to-[#2e1a55] bg-clip-text text-transparent"
 ...
 <motion.h3  className="text-3xl md:text-4xl font-bold mb-8 bg-linear-to-r from-primary to-[#2e1a55] bg-clip-text text-transparent"
 ...
 index % 2 === 0  ? 'bg-card border border-border/50 hover:border-primary/50'  : 'bg-primary/10 border border-primary/20 hover:border-primary/50'
 }`}
 ...
 variants={itemVariants}
 className={`group p-6 rounded-2xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${
 index % 2 === 0  ? 'bg-primary/10 border border-primary/20 hover:border-primary/50'  : 'bg-card border border-border/50 hover:border-primary/50'
 }`}
 whileHover={{  scale: 1.02,
 y: -5,
 transition: { duration: 0.3 }
