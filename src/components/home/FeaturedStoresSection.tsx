  ...
  return (
    <section className="relative py-24 bg-white ">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8 border-b-2 border-zinc-900 pb-10">
          <motion.div
          ...
          <Button variant="inset" size="lg" asChild className="border-zinc-900">
