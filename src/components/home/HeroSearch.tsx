...
export default function HeroSearch() {
    ...
    const words = t.raw('hero.categoryWords') as string[];
        ...
        <section className="relative min-h-[100vh] flex flex-col items-center justify-center px-4 py-20 overflow-hidden bg-background">
            ...
            <div className="relative z-10 w-full max-w-4xl text-center">
                ...
                <div className="relative max-w-2xl mx-auto">
                    <form onSubmit={(e) => { e.preventDefault(); router.push(`/${locale}/marketplace?search=${searchQuery}`); }}
                    ...
                    >
                        ...
                        >
                            {t('hero.searchButton')} <ArrowRight className="w-4 h-4" />
                        </Button>
                    </form>
                        ...
                        {hasSearch && (
                            ...
                            >
                                <div className="max-h-[400px] overflow-y-auto">
                                    {searchLoading && <div className="p-4 text-xs text-muted-foreground animate-pulse">{t('searchResults.loading')}</div>}
                                    {/* Categorias Rápidas */}
