      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
          <motion.div
            ...
            className="flex-1"
          >
            <h2 className="text-6xl md:text-8xl font-black tracking-tighter text-white uppercase leading-[0.8]">
              DEALS <br />
          ...
          <Button
            variant="slide"
            className="group overflow-hidden px-8 py-4 border-2 border-white text-white text-xs font-black uppercase tracking-[0.2em] rounded-lg transition-colors duration-300"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6 h-auto md:h-[550px]">
          {deals.slice(0, 3).map((deal, idx) => (
            <motion.div
              ...
              className={`group relative overflow-hidden rounded-xl border border-white/10 bg-primary-dark/40 cursor-pointer ${
            ...
            >
              ...
              <div className="absolute inset-0 z-20 p-8 flex flex-col justify-end">
                <div className="flex flex-col gap-1 mb-4">
                  {deal.badge && (
                    <span className="w-fit bg-white text-primary text-[10px] font-black px-2 py-1 rounded-sm mb-2">
                      {deal.badge} OFF
                    </span>
                  )}
                  <p className="text-white/50 text-[10px] font-black uppercase tracking-widest">{deal.store}</p>
                  <h3 className={`font-black text-white uppercase tracking-tighter leading-[0.9] ${
                ...
                <div className="flex items-center justify-between pt-6 border-t border-white/10">
                  ...
                  {/* Pequeno botão outline dentro do card com o mesmo efeito */}
                  <Button variant="slide" className="relative overflow-hidden w-12 h-12 rounded-lg border-2 border-white/20 flex items-center justify-center p-0 transition-all">
                    <ArrowRight className="relative z-10 w-6 h-6 text-white group-hover:text-primary transition-colors" />
                  </Button>
                </div>
              </div>
            </motion.div>
