        ...
        <section className="py-24 bg-primary relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
                    ...
                    >
                        <span className="relative z-10 flex items-center gap-3 group-hover:text-primary transition-colors duration-300">{t('promotionalCards.viewCatalog')} <ArrowRight className="w-4 h-4" /></span>
                    </Button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-6 h-auto md:h-[550px]">
                    {deals.slice(0, 3).map((deal, idx) => (
                        <motion.div
                            ...
                            className={`group relative overflow-hidden rounded-xl border border-border/10 bg-primary-dark/40 cursor-pointer ${idx === 0 ? 'md:col-span-4 md:row-span-2' : 'md:col-span-2'
                                }`}
                        >
                            ...
                            <div className="absolute inset-0 z-20 p-8 flex flex-col justify-end bg-gradient-to-t from-black/60 to-transparent">
                                <div className="flex flex-col gap-1 mb-4">
                                    ...
                                    <h3 className={`font-black text-foreground uppercase tracking-tighter leading-[0.9] ${idx === 0 ? 'text-4xl md:text-6xl max-w-sm' : 'text-2xl'
                                        }`}>
                                        {deal.title}
                                    </h3>
                                </div>
