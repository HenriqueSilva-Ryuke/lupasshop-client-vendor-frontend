        ...
        <section className="relative py-20 overflow-hidden bg-background">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
                ...
                <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6 border-b-2 border-border pb-8">
                    ...
                    <Link href={`/${locale}/marketplace`} className="hidden md:flex items-center gap-3">
                        <Button className="font-black text-sm uppercase border-2">
                ...
                {categoriesLoading ? (
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                        {[...Array(6)].map((_, i) => (
                            <div key={i} className="h-32 bg-muted bg-card rounded-lg animate-pulse" />
                        ))}
                    </div>
                ) : (
                ...
                <div className="mt-8 md:hidden">
                    <Link href={`/${locale}/marketplace`}>
                        <Button variant="inset" size="xl" className="w-full border-2">
