          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="relative p-2 rounded-full hover:bg-gray-100 hover:bg-gray-700 text-text-sub-light text-text-sub-dark transition-colors"
              >
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-80 bg-white bg-card-dark rounded-xl shadow-2xl border border-gray-200 border-gray-700 overflow-hidden z-50">
                  <div className="p-4 border-b border-gray-100 border-gray-700 bg-gray-50 bg-gray-800">
                    <h3 className="text-sm font-bold text-text-main-light text-text-main-dark">Notificações</h3>
                  </div>
                  <div className="max-h-96 overflow-y-auto">
                    <div className="p-4 hover:bg-gray-50 hover:bg-gray-800 transition-colors cursor-pointer border-b border-gray-100 border-gray-700">
                    ...
                    <div className="p-4 hover:bg-gray-50 hover:bg-gray-800 transition-colors cursor-pointer">
                      <div className="flex gap-3">
                  ...
                  <div className="p-3 border-t border-gray-100 border-gray-700 bg-gray-50 bg-gray-800">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 p-1 rounded-full hover:bg-gray-100 hover:bg-gray-700 transition-colors"
              >
                <div
              ...
              {/* User Dropdown */}
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-64 bg-white bg-card-dark rounded-xl shadow-2xl border border-gray-200 border-gray-700 overflow-hidden z-50">
                  <div className="p-4 border-b border-gray-100 border-gray-700 bg-gray-50 bg-gray-800">
                  ...
                  <div className="p-2">
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 hover:bg-gray-700 text-text-main-light text-text-main-dark transition-colors"
                    >
                  ...
                  <div className="p-2 border-t border-gray-100 border-gray-700">
                    <button
                      onClick={() => {
