                ...
                <table className="w-full text-left">
                    <thead>
                        <tr className="bg-muted border-b border-gray-100">
                            ...
                            <th className="px-6 py-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">{t('stock')}</th>
                            <th className="px-6 py-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Status</th>
                            <th className="px-6 py-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider text-right">{t('general')}</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100">
                        {products.map((product) => (
                            <tr key={product.id} className="hover:bg-muted transition-colors">
                                ...
                                <td className="px-6 py-4 text-sm text-muted-foreground">{product.stock}</td>
                                <td className="px-6 py-4">
