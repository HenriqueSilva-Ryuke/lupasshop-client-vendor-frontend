...
export function UserSidebar() {
  ...
  const sidebarItems = [
    { icon: User, label: t('myProfile'), href: '/user/profile' },
    { icon: ShoppingBag, label: t('myOrders'), href: '/user/orders' },
    { icon: MapPin, label: t('addresses'), href: '/user/addresses' },
    { icon: Heart, label: t('wishlist'), href: '/user/wishlist' },
    { icon: CreditCard, label: t('cardsPayments'), href: '/user/finances' },
  ];
